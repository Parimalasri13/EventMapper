...
//       <div className="slider-unique" style={{ transform: `translateX(${isSignup ? 100 : 0}px)` }}></div>
...
//               />
//               <button type="submit" className="clkbtn-unique">Signup</button>
//             </form>
//           </div>
//         ) : (
...
//                 onChange={(e) => setPassword(e.target.value)}
//               />
//               <button type="submit" className="clkbtn-unique">Login</button>
//             </form>
//           </div>
//         )}
//       </div>
